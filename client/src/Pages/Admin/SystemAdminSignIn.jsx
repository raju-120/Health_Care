  ...
  return (
    <div>
      <div className="max-w-full py-5">
        <h1 className="text-4xl font-semibold text-center my-10 uppercase">Sign IN as System Admin</h1>
        <div className="lg:flex justify-around">
          ...
          <div className="lg:w-2/5 my-24">
            ...
            <p className='ml-2 text-lg mt-4 '>
                <span>Log in as </span>
                <Link to="/admin">
                    <span className="text-blue-500 text-xl hover:bg-slate-300 p-2 rounded-lg">Admin</span>
                </Link>
            </p> 
