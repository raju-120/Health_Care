...
export default function Footer() {
  ...
  return (
    <div className="mt-16">
      <footer
        className="cs_footer cs_style_1 cs_bg_filed cs_primary_bg"
        data-src="../assets/images/footer_bg.jpeg"
      >
            ...
            <div className="row cs_gap_y_30  items-center">
              <div className="col-lg-4">
                <div className="cs_footer_widget cs_text_widget">
                  ...
                  <p className="cs_fs_18 cs_white_color">
                    Get a full control of your health in the digital world with
                    simple knock at our door. Our service at your door to serve
                    you.
                  </p>
                  <h3 className="cs_fs_24 cs_white_color cs_semibold">
                    Follow us on
                  </h3>
        ...
        <div className="cs_footer_bottom">
          <div className="container">
            <div className="cs_footer_bottom_text">
              <div className="cs-copyright cs_fs_18 cs_white_color text-center">
                Copyright © {new Date().getFullYear()} - All right reserved by
                <a
                  href="https://github.com/raju-120/Health_Care"
                  target="_blank"
                  className="cs_profile_link cs_accent_color_v1 ml-2"
                >
                  Raju
                </a>
              </div>
